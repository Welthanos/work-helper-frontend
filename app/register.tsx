      ...
      <View style={styles.container}>
         ...
         <View style={styles.formArea}>
            ...
            <View style={styles.inputGroup}>
               ...
               <TextInput placeholder='Nome' placeholderTextColor='gray' style={styles.input} />
            </View>
            ...
            <View style={styles.inputGroup}>
               <MaterialIcons name='lock' size={20} color='gray' style={styles.iconLeft} />
               <TextInput placeholder='Confirmar senha' placeholderTextColor='gray' secureTextEntry style={styles.input} />
            </View>
            ...
            <Text style={styles.loginPrompt}>
               Já possui uma conta?{' '}
               <Text onPress={goToLoginScreen} style={styles.loginLink}>Faça login.</Text>
            </Text>
         </View>
      </View>
   );
