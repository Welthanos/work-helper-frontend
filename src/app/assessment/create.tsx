...
export default function AssessmentCreateScreen() {
    const { surveyId } = useLocalSearchParams();
    const [isSexDropdownOpen, setSexDropdownOpen] = useState(false);
    const { formState, setFormState, formLoading, saveAssessment, } = useAssessments(surveyId as string);
                ...
                <View style={styles.rowContainer}>
                    <View style={styles.fieldWrapper}>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <TextInput placeholder='000.000.000-00' placeholderTextColor={Colors.blueGray} style={styles.input} value={formState.worker_cpf} onChangeText={(text) => handleFormChange('worker_cpf', maskCpf(text))} keyboardType='numeric' maxLength={14} />
                        </View>
                    </View>
                    <View style={styles.fieldWrapper}>
